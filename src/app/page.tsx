...
const content: contentSection[] = [
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-work_experience_orange">Senior Engineer</span> with <span className="text-work_experience_orange">6+ years</span> of experience in the software industry
        </div>
      ),
    },
          ...
          <div className="min-h-screen relative">
            <FadeIn className="max-w-5xl pt-40 md:pt-[20vh] 2xl:pt-[30vh]">
              <h1 className="font-display text-5xl font-medium tracking-tight [text-wrap:balance] sm:text-6xl">
                Nakao Hideo<span className="wave">👋</span>
              </h1>
